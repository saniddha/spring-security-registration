...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final Privilege managePrivilege = createPrivilegeIfNotFound("MANAGE_USERS_PRIVILEGE");
        ...
        final Role manageRole = createRoleIfNotFound("ROLE_MANAGER", managerPrivileges);

        // == create initial user
        createUserIfNotFound("test@test.com", "Test", "Test", "test", new ArrayList<>(Arrays.asList(adminRole)));
        createUserIfNotFound("testM@test.com", "TestM", "TestM", "test", new ArrayList<>(Arrays.asList(manageRole)));
